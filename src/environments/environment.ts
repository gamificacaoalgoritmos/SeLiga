...
export const environment = {
  production: false,
  firebase: {
    apiKey: "AIzaSyA3w1n5JWMphhaIYVkUVM6TITGZZofz70s",
    authDomain: "questoes-5e22b.firebaseapp.com",
    databaseURL: "https://questoes-5e22b.firebaseio.com",
    projectId: "questoes-5e22b",
    storageBucket: "questoes-5e22b.appspot.com",
    messagingSenderId: "783077404069",
  },
  ...
  "operation-not-supported-in-this-environment": "Esta operação não é suportada no ambiente em que esta aplicação está rodando. \\O protocolo local deve ser http, https ou chrome-extension e o armazenamento web deve estar habilitado.",
  ...
  "auth/wrong-password": "O valor fornecido para a propriedade do usuário 'senha' é inválido.",
  "auth/weak-password": "A senha precisa ser maior que 6 caracteres",
  "auth/argument-error": "Preencha todos os campos!"
  },
};
